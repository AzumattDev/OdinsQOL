    ...
    public partial class OdinQOLplugin
    {
        ...
        public void LoadConfig()
        {
            ...
            clockUseOSFont = config("Clock", "ClockUseOSFont", false,
                "Set to true to specify the name of a font from your OS; otherwise limited to fonts in the game resources", false);
            ...
            clockString = config("Clock", "ClockString", "<b>{0}</b>",
                "Formatted clock string - {0} is replaced by the actual time string, {1} is replaced by the fuzzy string, {2} is replaced by the current day", false);
            ...
            clockFuzzyStrings = config("Clock", "ClockFuzzyStrings",
                ...
                "Fuzzy time strings to split up the day into custom periods if ClockFormat is set to 'fuzzy'; comma-separated", false);
