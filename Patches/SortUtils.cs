...
{
    public static void SortByType(ShowContainerContentsPatch.SortType type, List<ItemData> items, bool asc)
    {
        // combine
        ...
        switch (type)
        {
            case ShowContainerContentsPatch.SortType.Name:
                SortByName(items, asc);
                break;
            case ShowContainerContentsPatch.SortType.Weight:
                SortByWeight(items, asc);
                break;
            case ShowContainerContentsPatch.SortType.Value:
                SortByValue(items, asc);
                break;
            case ShowContainerContentsPatch.SortType.Amount:
